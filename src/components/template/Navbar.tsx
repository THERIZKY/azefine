                ...
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="hidden lg:flex items-center space-x-8">
                        {navLinks.map((link) => (
                            <Link
                                key={link.path}
                                href={link.path}
                                className={`text-sm font-semibold transition-all duration-200 relative group py-2 ${
                                    isActive(link.path)
                            ...
                            >
                                ...
                                <span
                                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-brand rounded-full transform transition-transform duration-300 origin-left ${isActive(link.path) ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"}`}
                                ></span>
                            </Link>
                        ))}
                    </div>
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        ...
                        {user ? (
                            <div className="hidden lg:flex items-center gap-3">
                                <Link
                                    href="/user-dashboard"
                                    className="text-sm font-bold text-slate-700 dark:text-white hover:text-brand flex items-center gap-2 group"
                                >
                            ...
                            <div className="flex items-center gap-3">
                                <Button
                                    asChild
                                    variant="default"
                                    className="!py-2.5 !px-6 text-sm !rounded-full shadow-brand/20"
                                >
                    ...
                    <div className="lg:hidden flex items-center gap-3">
                        ...
                        <button
                            ...
                            className="text-slate-800 dark:text-white focus:outline-none p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
                        >
                            ...
                            {user ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="w-full py-3 text-red-500 font-bold flex items-center justify-center gap-2 border border-red-100 dark:border-red-900/30 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors"
                                    >
